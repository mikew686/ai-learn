...
- **Refinement through examples**: Where an example script exists in `src/`, the pattern section links to it
...
**Example**: [understand_llm_models.py](../src/understand_llm_models.py)

**Related**: [understand_embedding_models.py](../src/understand_embedding_models.py), [understand_reasoning_model.py](../src/understand_reasoning_model.py)
...
**Example**: [system_prompt_example.py](../src/system_prompt_example.py)

**Related**: [schema_driven_translation.py](../src/schema_driven_translation.py), [tool_use_patterns.py](../src/tool_use_patterns.py), [embeddings_vector_search.py](../src/embeddings_vector_search.py)
...
**Example**: [language_assessment_structured_output.py](../src/language_assessment_structured_output.py)

**Related**: [schema_driven_translation.py](../src/schema_driven_translation.py), [embeddings_vector_search.py](../src/embeddings_vector_search.py)
...
**Example**: [tool_use_patterns.py](../src/tool_use_patterns.py)

**Related**: [schema_driven_translation.py](../src/schema_driven_translation.py)
...
**Example**: [schema_driven_translation.py](../src/schema_driven_translation.py)

**Related**: [tool_use_patterns.py](../src/tool_use_patterns.py) (descriptive tool schemas)
...
- Dynamic example selection based on language pair or embedding similarity (as in [embeddings_vector_search.py](../src/embeddings_vector_search.py))
...
- **Example and Related**: **Example** is the primary script that best demonstrates the pattern (one per pattern). **Related** lists any other `src/` scripts that use this pattern as a secondary technology. Use Example to learn the pattern; Related to see it in context elsewhere.
