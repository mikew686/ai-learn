...
**Example Implementation**: See `scripts/examples/tool_use_patterns.py` for complete working examples of all three patterns with translation use cases.
...
Function Calling is Pattern 4 in the [learning progression](./learning_progression.md). Learn it after **Understanding Models**, **Prompt Engineering**, and **Structured Output**; then **Schema-Driven Inference** (Pattern 5) and **Embeddings** (Pattern 6). Example: [tool_use_patterns.py](../scripts/examples/tool_use_patterns.py).
