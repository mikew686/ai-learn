...
```bash
python -m scripts.examples.understand_embedding_models [--model CHAT_MODEL] [--embedding-model EMB_MODEL] [--retrieve-after N] [--retrieve-k K] [--temperature T] [--max-tokens N]
```
